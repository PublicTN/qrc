...
`associations`- перечень кодов ассоциаций из ПИМ, в которых приведена связь текущего запрашиваемого sku с другими sku. По такому принципу привязываются sku продуктов к sku систем, а также sku комплектации и сопутствующих товаров. В атрибуте label может указываться название ассоциации системы в формате [Тип материала] - [Название слоя системы] [Позиция маркера слоя на изображении системы], например, "Главный - Пароизоляционный слой 6".
